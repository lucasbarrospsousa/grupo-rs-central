...
export function openVisitForm({repo,branch,showModal,render,visit=null}){
 ...
 const valid=()=>{submit.disabled=busy||(!visit&&(!client||!vehicle?.serial||!repo.list(branch).some(r=>r.serial===vehicle.serial)));};

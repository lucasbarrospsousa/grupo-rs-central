...
A autorização da hospedagem Sites é independente do login da Central. A publicação mantém a audiência privada existente. Um usuário externo precisa também de acesso à hospedagem.

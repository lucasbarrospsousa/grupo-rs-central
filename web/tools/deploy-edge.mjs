...
const values={CENTRAL_DB_USER:runtime.user,CENTRAL_DB_PASSWORD:runtime.password,CENTRAL_DB_CA:await readFile(privatePath('supabase-ca.crt'),'utf8'),CENTRAL_INTEGRATIONS_JSON:JSON.stringify(integrationSecrets()),CENTRAL_BRIDGE_TOKEN:bridge,CENTRAL_PUBLIC_ORIGIN:'https://grupo-rs-central.lucasbarrosp.chatgpt.site',COOKIE_SECURE:'1'};

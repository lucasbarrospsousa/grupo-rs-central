...
export function integrationSecrets(){
 ...
 if(process.env.CENTRAL_INTEGRATIONS_JSON){try{cached=JSON.parse(process.env.CENTRAL_INTEGRATIONS_JSON);return cached;}catch{throw Error('Configuração das integrações inválida no servidor.');}}

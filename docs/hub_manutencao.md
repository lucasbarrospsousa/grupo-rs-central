...
Tooltip informa base, quantidade, origem e horário. Clique abre uma janela ampla com cabeçalho azul e total, filtrada na base clicada. Seleção Todas as bases reúne os registros sem deduplicar veículos de filiais diferentes. Busca por cliente/placa/aparelho e filtros de base/APN operam em memória. A tabela tem cabeçalho escuro e seis colunas: cliente, placa, equipamento, APN, telefone do chip e última comunicação. Faixas amarelas separam os grupos de APN e mostram o total do grupo nos filtros atuais, incluindo outras páginas; em Todas as bases, o nome da filial aparece na faixa para evitar mistura. Linhas alternadas, APN verde e telefone azul seguem a referência aprovada. São 25 registros por página, com rolagem interna da tabela. Duplo clique na linha abre detalhes, incluindo a origem e horário da consulta. Aviso distingue consulta completa, parcial e atualização; Atualizar listas relê as quatro bases. Nenhuma ação altera os veículos.
